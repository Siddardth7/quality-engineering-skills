...
- **Version Alignment Verification:** To confirm that the runtime server matches the workspace platform version (`0.2.0`).
...
3. **Validate Response Payload:**
   ...
   - Verify `"version"` aligns with platform workspace version `0.2.0`.
