...
`v1.0.0` ships when:
1. **11 engine-powered domain skills across 8 domains** are functional, documented, and tested: FMEA, SPC, MSA, Control Plan, three RCA skills, NCR, COPQ, PPAP, and Supplier SCAR.
