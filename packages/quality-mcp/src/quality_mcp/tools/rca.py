"""
rca.py
FastMCP tools for 5-Why Root Cause Analysis (RCA) validation and visual canvas rendering.

Exposes deterministic 5-Why causal chain validation, reverse therefore logic checking,
anti-pattern detection, systemic root cause classification, and themed HTML canvas generation
from quality_core.rca and quality_core.canvas to AI agents and MCP client hosts.
...
from quality_core.canvas.rca import SAMPLE_FIVE_WHY_STEPS, FiveWhyCanvas
