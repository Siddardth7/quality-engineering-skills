...
- **For AIAG/ISO claims the on-machine manuals are the ONLY valid sources:**
  ...
  - **PPAP:** AIAG *Production Part Approval Process* Reference Manual (4th Edition, 2006) at `/Users/sid/Documents/Upskill/SixSigma/PPAP/AIAG_PPAP_4th_Edition.md` (training deck at `/Users/sid/Documents/Upskill/SixSigma/AIAG Production Part Approval Process (PPAP), 4th Edition (2006).pdf` is secondary / non-authoritative).
