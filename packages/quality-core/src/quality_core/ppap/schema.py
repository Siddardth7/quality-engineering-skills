...
PPAP_ELEMENT_NAMES: dict[PPAPElementId, str] = {
...
PPAP_ELEMENT_NUMBERS: dict[int, PPAPElementId] = {
    i + 1: elem_id for i, elem_id in enumerate(PPAP_ELEMENT_IDS)
}

PPAP_ELEMENT_ALIASES: dict[str, PPAPElementId] = {
    # 2.2.1
    "1": "2.2.1",
    "2.2.1": "2.2.1",
...
SUBMISSION_LEVEL_DESCRIPTIONS: dict[SubmissionLevel, str] = {
...
SUBMISSION_LEVEL_ALIASES: dict[str, SubmissionLevel] = {
    "1": 1,
    "level 1": 1,
    "level_1": 1,
    "level1": 1,
...
REASON_FOR_SUBMISSION_ALIASES: dict[str, ReasonForSubmission] = {
...
EVIDENCE_STATUS_ALIASES: dict[str, EvidenceStatus] = {
    # submitted (S)
    "s": "submitted",
    "submitted": "submitted",
    "submit": "submitted",
